    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <mdb-list-group class="list-group-flush">
        <router-link to="/home" @click.native="activeItem = 1">
          <mdb-list-group-item :action="true" :class="activeItem === 1 && 'active'"><mdb-icon icon="calendar-check" class="mr-3"/>หน้าหลัก</mdb-list-group-item>
        </router-link>
        <router-link to="/contacts" @click.native="activeItem = 3">
          <mdb-list-group-item :action="true" :class="activeItem === 3 && 'active'"><mdb-icon icon="calendar-check" class="mr-3"/>ผู้ติดต่อ</mdb-list-group-item>
        </router-link>
        ...
        <router-link to="/profile" @click.native="activeItem = 5">
          <mdb-list-group-item :action="true" :class="activeItem === 5 && 'active'"><mdb-icon icon="calendar-check" class="mr-3"/>โปร์ไฟล์</mdb-list-group-item>
        </router-link>
      </mdb-list-group>
    </div>
    <!-- /Sidebar  -->
