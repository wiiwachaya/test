  ...
  <div class="flexible-content">
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <mdb-list-group class="list-group-flush">
        ...
        <router-link to="/task" @click.native="activeItem = 5">
          <mdb-list-group-item :action="true" :class="activeItem === 5 && 'active'"><mdb-icon icon="map" class="mr-3"/>Task</mdb-list-group-item>
        </router-link>
        <router-link to="/404" @click.native="activeItem = 6">
          <mdb-list-group-item :action="true" :class="activeItem === 6 && 'active'"><mdb-icon icon="exclamation" class="mr-3"/>404</mdb-list-group-item>
        </router-link>
        <router-link to="/task_work" @click.native="activeItem = 7">
          <mdb-list-group-item :action="true" :class="activeItem === 7 && 'active'"><mdb-icon icon="exclamation" class="mr-3"/>404</mdb-list-group-item>
        </router-link>
      </mdb-list-group>
    </div>
    <!-- /Sidebar  -->
